...
options={
    ...
    'lines.markeredgecolor': 'none', #'auto'
    'lines.markersize':3,
    'lines.linewidth':linewidth*2,

    'patch.linewidth':linewidth,
    'patch.facecolor': 'none', #'C0'
    'patch.force_edgecolor': False, #False
    'scatter.edgecolors': 'none', #'face' '000000'

    'xtick.labelsize': labelsize, #'medium'
    'xtick.color': 'black', #'black'
    'xtick.direction': 'in', #'in'
    ...
    'ytick.color': 'black', #'black'
    'ytick.direction': 'in', #'in'
